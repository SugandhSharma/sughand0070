...
all_clear_button.configure(fg="white",bg="white",font=("Arial",12,"bold"))

delete_button=tk.Button(window,text="del",width=10,command=delete_last_character)
delete_button.grid(row=0,column=3,padx=5,pady=5)
delete_button.configure(fg="white",bg="black",font=("Arial",12,"bold"))
